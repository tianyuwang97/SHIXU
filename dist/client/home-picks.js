  ...
  async function change(next, trigger = null) {
    ...
    try {
      ...
      if (guestReturn && !active) {
        $2("decisionInvitation").innerHTML = '<a href="' + loginURL2() + '"><span class="invitation-action">\u767B\u5F55</span><strong>\u65F6\u5E8F(SHIXU)</strong><span>\u770B\u89C1\u6295\u8D44\u7684\u53E6\u4E00\u9762</span></a>';
